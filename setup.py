...
def main():
    ...
    setup(
        name="ctodd-python-lib-slack",
        version=version,
        python_requires=">3.0,<3.7",
        description=("Python utilities used for interacting with Slack"),
        url="https://github.com/ChristopherHaydenTodd/ctodd-python-lib-slack",
        author="Christopher H. Todd",
        author_email="Christopher.Hayden.Todd@gmail.com",
        classifiers=["Programming Language :: Python"],
        keywords=["python", "libraries", "Slack"],
        packages=packages,
